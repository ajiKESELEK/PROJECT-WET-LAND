            ...
            <div class="col-md-5 box-login bg-filter text-white p-5">
                    ...
                    <div class="form">
                        <form method="post" action="{{ route('register.store') }}">
                            ...
                            <button type="submit" class="btn active text-white"><i class="fas fa-user-plus"></i> Submit</button>
                            <a href="/login" class="btn active text-white"><i class="fas fa-arrow-circle-left"></i> Kembali ke halaman login</a>
                            </div>
                          </form>
                    </div>
                </div>
